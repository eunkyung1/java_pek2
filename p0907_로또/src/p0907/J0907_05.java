...
public class J0907_05 {
	private static final char[] StrNo = null;

	public static void main(String[] args) {
		//주택복권 1조 12345 1조:0-9까지  00000-99999
		// 5 - 1000원 45-10000원 345-100000원 2345-1000000 12345-10000000
		//1-12345 1억원
		Scanner scan = new Scanner(System.in);
		
		//1조 - 0-9
		int fNo = (int)(Math.random()*9)+1;  //1-9까지
//		int firstNo = (int)(Math.random()*10);  //0~9까지
		...
		System.out.println("입력한 번호 :"+inputNo);
		...
		if(count==0) {
			...
			System.out.println("1개 맞췄습니다. 당첨 :1000원입니다.");
		}else if(count==2) {
			System.out.println("2개 맞췄습니다. 당첨:1,000원입니다.");
		}else if(count==3) {
			System.out.println("3개 맞췄습니다. 당첨:10,000원입니다.");
		}else if(count==4) {
			System.out.println("4개 맞췄습니다. 당첨:100,000원입니다.");
		}else if(count==5) {
			System.out.println("5개 맞췄습니다. 당첨:1,000,000원입니다.");
		}else if(count==6) {
			System.out.println("6개 맞췄습니다. 당첨:1,000,000,000원입니다.");
		}
